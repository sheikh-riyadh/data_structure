...
int main()
{
    ...
    cycle এমন এক বিষয় যেটা মূলত infinite চলতে থাকে কখন বন্ধ হয় না যদি আমাদের লিস্টের মধ্যে এমন কিছু থাকতে তাহলে এই
    fast and slow technic ব্যাবহার করে বের করতে পারি
